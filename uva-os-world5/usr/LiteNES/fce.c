...
// fxl: read&check header, then read program
int fce_load_rom(char *rom)
{
    ...
    static byte buf[1048576];       // fxl: another big buf
...
void fce_update_screen()        // fxl: called by ppu cycle
{
